...
BASE_DIR = '/workspace/mnt/cluster/HDD/azuma/Others/github/Drug-Interaction-Research'
df_drugs_smiles = pd.read_csv(BASE_DIR+'/dataset/drugbank/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv(BASE_DIR+'/dataset/drugbank/ddis.csv')
