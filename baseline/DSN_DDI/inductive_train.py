# -*- coding: utf-8 -*-
"""
Created on 2025-05-20 (Tue) 22:45:40
...
import sys
sys.path.append(BASE_DIR+'/github/XAI-DDI/DSN_DDI')
...
# %% Dataset
data_path = BASE_DIR+'/github/Drug-Interaction-Research/dataset/'
