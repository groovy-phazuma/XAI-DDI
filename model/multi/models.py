...
class MVN_DDI(nn.Module):
    def __init__(self, in_features, hidd_dim, kge_dim, rel_total, heads_out_feat_params, blocks_params, kg_emb_dim, n_class=6, cross_attn=True):
        super().__init__()
        ...
        self.classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(kg_emb_dim // 4, n_class)
        )
