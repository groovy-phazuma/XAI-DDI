...
INPUT_YAML_DIR = f"{WORK_DIR}/results/260212_cyp3/inputs"
OUTPUT_DIR = f"{WORK_DIR}/results/260212_cyp3/outputs"
...
if __name__ == "__main__":
    ...
    # --- テスト実行の設定 ---
    target_hgncs = ['CYP21A2', 'CYP24A1', 'CYP26A1', 'CYP27A1', 'CYP27B1']
