...
260211
cyp1 (CYP11A1, CYP11B1, CYP11B2, CYP17A1, CYP19A1) に対して
cyp2 (CYP1A1, CYP1A2, CYP1B1) をループで回す
cyp3 (CYP21A2, CYP24A1, CYP26A1, CYP27A1, CYP27B1) をループで回す
cyp4 (CYP2A13, CYP2A6, CYP2B6, CYP2C19, CYP2C8) をループで回す
...
INPUT_YAML_DIR = f"{WORK_DIR}/results/260212_cyp4/inputs"
OUTPUT_DIR = f"{WORK_DIR}/results/260212_cyp4/outputs"
...
if __name__ == "__main__":
    ...
    # --- テスト実行の設定 ---
    target_hgncs = ['CYP2A13', 'CYP2A6', 'CYP2B6', 'CYP2C19', 'CYP2C8']
